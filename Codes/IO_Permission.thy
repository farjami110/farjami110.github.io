...
ax_IOP4i : "regular_pr \<^bold>\<diamond>\<^sup>4\<^sub>o" and
...
lemma IO2PSI: "((\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>2\<^sub>p\<beta>) \<and> (\<alpha> \<^bold>\<le> \<beta>)) \<longrightarrow> (\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>2\<^sub>p \<alpha>)" 
  unfolding regular_pr_def regular_pr_def   oops
...
lemma IO3PSI: "((\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>3\<^sub>p\<beta>) \<and> (\<alpha> \<^bold>\<le> \<beta>)) \<longrightarrow> (\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>3\<^sub>p \<alpha>)" using  ax_IOP3i 
  using antitone_def antitone_def by fastforce
...
lemma IO4PSI: "((\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>4\<^sub>p\<beta>) \<and> (\<alpha> \<^bold>\<le> \<beta>)) \<longrightarrow> (\<phi> \<^bold>\<le> \<^bold>\<diamond>\<^sup>4\<^sub>p \<alpha>)"   using ax_IOP1  oops
